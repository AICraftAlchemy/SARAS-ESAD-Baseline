...
parser.add_argument('--freezeupto', default=0, type=int, help='layer group number in ResNet up to which needs to be frozen')
...
parser.add_argument('--intial_val', default=9000, type=int, help='Initial number of training iterations before evaluation')
parser.add_argument('--val_step', default=1000, type=int, help='Number of training iterations before evaluation')
parser.add_argument('--iou_thresh', default=0.10, type=float, help='Evaluation threshold')
parser.add_argument('--conf_thresh', default=0.05, type=float, help='Confidence threshold for evaluation')
parser.add_argument('--nms_thresh', default=0.45, type=float, help='NMS threshold')
parser.add_argument('--topk', default=50, type=int, help='topk for evaluation')

# Progress logging
parser.add_argument('--log_start', default=1, type=int, help='start loging after k steps for text/tensorboard') # Let initial ripples settle down
...
parser.add_argument('--save_root', default='/content/esaddd/results/', help='Location to save checkpoint models') 
...
parser.add_argument('--model_dir', default='/home/system1-user3/Desktop/6630/esaddd/model/', help='Location to where imagenet pretrained models exists') 
# args.model_dir = ''
## Parse arguments
